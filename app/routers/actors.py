...
async def get_actor_specs(actor_uuid: str):
    ...
    with urllib.request.urlopen(f'https://raw.githubusercontent.com/dc-rahul/verified-sources/feature/google-drive-and-wikipedia-forked/verified_sources/{matching_actors[0].name}/specs.yml') as response:
